...
window.AI_DAILY = {
  ...
  news: [
    ...
    { t:'DeepSeek 发布 V4.1 Flash 并首创峰谷定价：闲时半价', p:'DeepSeek 在 V4-Pro（1.6T 参数 MoE、百万上下文）基础上发布 V4.1 Flash，8 月 17 日起峰谷定价生效为行业首创——闲时调用半价，普惠推理成本继续下探。', src:'CSDN', u:'https://blog.csdn.net/enheng1238/article/details/164328547' },
    { t:'Meta 发布新旗舰 Muse Spark 1.3，开源策略转向引社区关注', p:'Meta 以 Muse 品牌推进新模型：Muse Spark 1.3 登顶开源阵营，但公司正从开源 Llama 转向闭源 Muse，社区以 Llama 分叉填补缺口，开源/闭源策略仍在动态调整。', src:'慧博投研', u:'https://www.hibor.com.cn/wap_detail.aspx?id=5225046' },
    { t:'Anthropic Fable 5.1 / Mythos 5.1 加入 AI 价格战：缓存读取降价 75%', p:'Anthropic 将 Fable 5.1 缓存读取价格从 1 美元降至 0.25 美元，降幅 75%，高 Agent 负载场景成本最高可降约 45%；9 月 1 日 GA 定价 10/50 美元不变。', src:'CSDN / AI Business', u:'https://blog.csdn.net/enheng1238/article/details/164328547' },
    ...
    { t:'黄仁勋 G20 部长会议敦促各国加建数据中心', p:'英伟达 CEO 黄仁勋在 G20 部长会议上警告"只谈风险不建基础设施"的危险，敦促各国加速数据中心建设；HPE 季度营收同比增 34% 至 122 亿美元，新签 35 亿美元服务器大单仍供不应求。', src:'CSDN', u:'https://blog.csdn.net/enheng1238/article/details/164328547' },
    { t:'特朗普联大演讲：称放缓 AI 发展论是"骗局"', p:'9 月 22 日特朗普在联合国大会演说中为 AI 发展背书，称放缓 AI 的言论是骗局，同时就伊朗核问题发出威胁，科技议题罕见进入联大演讲核心。', src:'财新网', u:'https://mini.caixin.com/2026-09-24/102488240.html' }
  ],
  skills: [
  ...
  hacks: [
    ...
    { t:'AI 短剧流水线：一个人月流水 6500 万美金的玩法', p:'昆仑万维 AI 短剧业务月流水破 6500 万美元，剧本、分镜、配音、剪辑全链路 AI 化，个人创作者也能跑通出海短剧。', src:'新华报业网 / 半年报', u:'https://www.xhby.net/content/s6a86a8c1e4b0eb7bb0f9f6a8.html' },
